...
3. El sistema debe permitir reemplazo selectivo y reemplazo masivo.
4. Debe mostrar los resultados actualizados en pantalla.
5. El usuario debe poder deshacer el último cambio.
6. Debe permitir guardar los archivos modificados.
7. Debe mostrar el nombre del archivo actual cargado.
8. La interfaz debe ser responsiva y clara.
